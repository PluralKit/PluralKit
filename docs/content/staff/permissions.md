...
- [Proxy logging](./logging) requires the **Send Messages** permission in the log channel.
- [Log cleanup](./compatibility#log-cleanup) requires the **Manage Messages** permission in the log channels.
