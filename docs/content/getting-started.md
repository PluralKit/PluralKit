...
Instead, you can give your member a simple, easy to type name, then set the member's [display name](./user-guide#member-display-names) to a more complex version. That'll get displayed when proxying, and then you can keep the following commands simple.
::: 
...
You could...
- [set up your member profile with descriptions, pronouns, etc](./user-guide#member-management)
- [log your switches](./user-guide#managing-switches)
- [configure privacy settings](./user-guide#privacy)
- or something else!

See the [User Guide](./user-guide) for a more complete reference of the bot's features.