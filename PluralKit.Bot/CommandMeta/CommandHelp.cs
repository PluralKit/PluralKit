...
public partial class CommandTree
{
    ...
    public static Command GroupPrivacy = new Command("group privacy", "group <group> privacy <name|description|icon|visibility|all> <public|private>", "Changes a group's privacy settings");
