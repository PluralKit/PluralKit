    ...
    public class MemberProxy
    {
        ...
        public async Task Proxy(Context ctx, PKMember target)
        {
            ...
            else if (ctx.Match("add", "append"))
            {
                ...
                if (tagToAdd.IsEmpty) throw Errors.EmptyProxyTags(ctx.CommandPrefix, target);
            ...
            else if (ctx.Match("remove", "delete"))
            {
                ...
                if (tagToRemove.IsEmpty) throw Errors.EmptyProxyTags(ctx.CommandPrefix, target);
            ...
            else
            {
                ...
                if (requestedTag.IsEmpty) throw Errors.EmptyProxyTags(ctx.CommandPrefix, target);
