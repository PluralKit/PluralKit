...
public static class Errors
{
    ...
    public static PKError NoSystemError =>
        new("You do not have a system registered with PluralKit. To create one, type `sp;system new`.");

    public static PKError ExistingSystemError => new(
        "You already have a system registered with PluralKit. To view it, type `sp;system`. If you'd like to delete your system and start anew, type `sp;system delete`, or if you'd like to unlink this account from it, type `sp;unlink`.");
